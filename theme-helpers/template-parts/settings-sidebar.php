<div class="d-flex flex-column border-success">
    <div class="pr-3">
        <img class="px-5 w-100 side_image" src="/wp-content/themes/scheduler_mvp/img/free.png" alt="">
    </div>
    <div class="card shadow-lg bottom_rounded top_rounded border-top p-3">
        <div class="card-header bg-transparent border-0 pt-4">
            <p class="text-warning h5">Копи бесплатные уроки, не пропуская занятия</p>
        </div>
        <div class="card-body">
            <p class="text-muted">Чтобы ничего не пропустить настрой напоминалки!</p>
        </div>
        <div class="card-footer bg-transparent border-0">
            <p class="h3 pb-3">Notofication settings</p>
            <div id="configs">
                <p>Get on e-mail: <span>vasina@gmail.ru</span>
