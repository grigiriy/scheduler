    ...
    <div class="<?= $is_modes ? 'col-12' : 'col-6' ?> d-flex">
        <div class="mr-3">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                style="enable-background:new 0 0 32.75 32.75;" xml:space="preserve">
                <!-- Icons made by Freepik (https://www.flaticon.com/authors/freepik) from flaticon(https://www.flaticon.com/" title="Flaticon) -->
                <g>
                    <g>
                        <path fill="#60a9f8"
                            d="M29.375,1.25h-1.123c0.029-0.093,0.059-0.186,0.059-0.289c0-0.53-0.432-0.961-0.963-0.961s-0.961,0.431-0.961,0.961
