    ...
    <div class="modal-dialog me-modal">
        <div class="modal-content bottom_rounded top_rounded">
            ...
            <div class="modal-body pt-0 px-sm-5 px-3">
                ...
                <p class="text-center"><a href="javascript:void(0)" class="text-muted" data-modalto="reset" onclick="changeModals(this)">Forget your password?</a></p>
                <p class="text-center">New to magicEnglish?<span class="d-sm-inline d-none arrow_symbol mx-3">⟶</span><a
                href="javascript:void(0)" data-modalto="signin" class="d-sm-inline d-block" onclick="changeModals(this)">Create
                an account.</a></p>
            </div>
        </div>
    </div>
