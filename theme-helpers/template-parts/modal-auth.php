        ...
        <div class="modal-content bottom_rounded top_rounded">
            ...
            <div class="modal-body pt-0">
                ...
                <form class="px-5 form-group" name="loginform" action="/wp-login.php" method="post">
                    <p>
                        <input class="form-control" type="text" name="log" placeholder="your Email" value="" size="20"
                            tabindex="10" />
                    </p>
                    <p>
                ...
                <p class="text-center">New to magicEnglish?<span class="arrow_symbol mx-3">⟶</span><a href="#reg">Create
                        an account.</a></p>
            </div>
        </div>
    </div>
