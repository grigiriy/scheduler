        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8 offset-md-1 offset-0 d-block d-md-flex pr-0">
                ...
                <button type="button" class="d-block mt-3 mt-md-0 btn btn-warning btn-round py-3 px-5 mx-auto align-self-center"
                    data-target="#signup" data-toggle="modal" onclick="push_hash(this)">Try
                    free!</button>
                <button type="button" class="d-block mt-3 mt-md-0 btn btn-primary btn-round py-3 px-5 ml-auto align-self-center"
                    data-target="#login" data-toggle="modal" onclick="push_hash(this)">
                    ...
                    Log in</button>
                <a class="position-absolute _reg text-dark" href="javascript:void(0)" data-target="#signup"
                    data-toggle="modal" onclick="push_hash(this)">Registration<span class="arrow_symbol ml-1">⟶</span></a>
                <?php } else { ?>
